...
Inspired by [PRODIGY-LIG](https://github.com/haddocking/prodigy-lig), ProWhiz replaces the linear contact-count model with a learned E(3)-equivariant graph neural network trained on protein-ligand crystal structures.
